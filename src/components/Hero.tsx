  ...
  return (
    <section className="relative bg-gray-50 overflow-hidden">
      <div className="absolute inset-0 z-0 opacity-20">
        {/* Map background */}
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/4381392/pexels-photo-4381392.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750')] bg-cover bg-center"></div>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center relative z-10">
        ...
        <div className="md:w-1/2 relative">
          <img 
            src="https://images.pexels.com/photos/11349374/pexels-photo-11349374.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750" 
            alt="Toyota SUV" 
